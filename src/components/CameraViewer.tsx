        ...
        <div className="overflow-hidden h-full flex flex-col bg-black/85 backdrop-blur-xl border border-[var(--border-primary)]" style={{ boxShadow: '0 20px 50px rgba(0,0,0,0.9), inset 0 0 30px rgba(0,0,0,0.8)' }}>
            ...
            {externalOnly ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/90">
                <div className="text-center">
                  ...
                  <button onClick={() => { setError(false); setRefreshKey(k => k + 1); }} className="block mx-auto mt-3 px-3 py-1 text-[8px] font-mono text-[var(--cyan-primary)] border border-[var(--cyan-primary)]/30 rounded hover:bg-[var(--cyan-primary)]/10 transition-colors tracking-wider">
                    RETRY
                  </button>
                </div>
              </div>
          ...
          <div className="bg-black border-t border-[var(--border-primary)] relative z-10">
            ...
            <div className="h-[2px] w-full bg-[var(--border-primary)] overflow-hidden relative">
              <div className="absolute top-0 bottom-0 left-0 bg-[var(--gold-primary)] shadow-[0_0_8px_var(--gold-primary)] w-1/3" style={{ animation: 'progress-glow-slide 2s cubic-bezier(0.4, 0, 0.2, 1) infinite' }} />
            </div>
          </div>
        </div>
      </motion.div>
